...
function Reviews({ user }) {
    ...
    return (
        <div>
            ...
            {restaurant.image_url ? <img src={`${restaurant.image_url}`} alt='...'width="400" height="400" /> : <img src="https://thumbs.dreamstime.com/b/no-image-available-icon-photo-camera-flat-vector-illustration-132483141.jpg" alt='...' width="400" height="400" />}
